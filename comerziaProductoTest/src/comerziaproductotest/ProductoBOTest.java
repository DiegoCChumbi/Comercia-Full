...
//        testProductoBOEliminar();
    ...
    private static void testProductoBOObtenerPorId(ArrayList<Integer> listaId) {
        ...
        for (Integer id : listaId) {
            ...
            System.out.println("idProducto: " + producto.getIdProducto()+ " " + producto.getNombreProducto()+ " " + producto.getPrecio().toString());
        }
    }
    ...
    private static void testProductoBOModificar(ArrayList<Integer> listaId) {
        ...
        Integer resultado = productoBO.modificar(listaId.get(0),"producto1",100.00,80);
