...
@WebService(serviceName = "AlmacenWS", targetNamespace = "http://services.comerziasoft.pucp.edu.pe")
...
public class AlmacenWS { 
    ...
    public ArrayList<ProductoAlmacenado> listarPorAlmacen(@WebParam(name = "idAlmacen")String id) { 
        return daoProductoAlmacenado.listarPorAlmacen(Integer.valueOf(id));
    } 
    
    @WebMethod(operationName = "buscarPorNombre") 
    public ArrayList<Producto> buscarProductos(@WebParam(name = "nombreProd")String nombre) { 
        return daoProducto.buscarProductos(nombre);
    } 
    @WebMethod(operationName = "buscarProductoPorId") 
    public Producto obtenerPorIdProd(@WebParam(name = "idProd")Integer idProducto) {
        return daoProducto.obtenerPorId(idProducto);
    }
    @WebMethod(operationName = "insertarProductoAlmacenado") 
    public Integer insertar(@WebParam(name = "idAlmacen")Integer idAlmacen, 
        ...
        return daoProductoAlmacenado.insertar(idAlmacen, fechaAlmacenado, stockActual, idProducto);
    }
