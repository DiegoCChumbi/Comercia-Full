...
public abstract class DAOImpl {
  ...
  private Integer ejecuta_DML(Tipo_Operacion tipo_Operacion) {
    ...
    try {
      ...
      switch (tipo_Operacion) {
        case Tipo_Operacion.INSERTAR -> sql = this.generarSQLParaInsercion();
        case Tipo_Operacion.MODIFICAR -> sql =
          this.generarSQLParaModificacion();
        case Tipo_Operacion.ELIMINAR -> sql = this.generarSQLParaEliminacion();
      }
  ...
  protected abstract void incluirValorDeParametrosParaInsercion()
    throws SQLException;
  ...
  protected abstract void incluirValorDeParametrosParaModificacion()
    throws SQLException;
  ...
  protected abstract void incluirValorDeParametrosParaEliminacion()
    throws SQLException;
  ...
  protected abstract void agregarObjetoALaLista(
    List lista,
    ResultSet resultSet
  ) throws SQLException;
  ...
  protected abstract void incluirValorDeParametrosParaObtenerPorId()
    throws SQLException;
  ...
  public Integer retornarUltimoAutoGenerado() {
    ...
    try {
      ...
      System.err.println(
        "Error al intentar retornarUltimoAutoGenerado - " + ex
      );
    }
    return resultado;
  }

  protected void incluirParametroString(Integer numeroParametro, String valor)
    throws SQLException {
    if (valor == null) {
  ...
  protected void incluirParametroInt(Integer numeroParametro, Integer valor)
    throws SQLException {
    if (valor == null) {
  ...
  protected void incluirParametroDate(Integer numeroParametro, Date valor)
    throws SQLException {
    if (valor == null) {
  ...
  protected void incluirParametroBoolean(
    Integer numeroParametro,
    Boolean valor
  ) throws SQLException {
    if (valor == null) {
  ...
  protected void incluirParametroString(String nombreParametro, String valor)
    throws SQLException {
    if (valor == null) {
  ...
  protected void incluirParametroInt(String nombreParametro, Integer valor)
    throws SQLException {
    if (valor == null) {
      this.statement.setNull(nombreParametro, Types.INTEGER);
    } else {
      this.statement.setInt(nombreParametro, valor);
    }
  }

  protected void incluirParametroDate(String nombreParametro, Date valor)
    throws SQLException {
    java.sql.Date sqlDate = new java.sql.Date(valor.getTime());
    if (valor == null) {
  ...
  protected void incluirParametroBoolean(String nombreParametro, Boolean valor)
    throws SQLException {
    if (valor == null) {
  ...
  protected void incluirParametroDouble(String nombreParametro, Double valor)
    throws SQLException {
    if (valor == null) {
      this.statement.setNull(nombreParametro, Types.DOUBLE);
    } else {
      this.statement.setDouble(nombreParametro, valor);
    }
  }

  protected void incluirParametroDouble(Integer numeroParametro, Double valor)
    throws SQLException {
    if (valor == null) {
