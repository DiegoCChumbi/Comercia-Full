...
public class LineaDocumentoDAOImpl
  extends DAOImpl
  implements LineaDocumentoDAO {
  ...
  public Boolean existeLineaDocumento(LineaDocumento linea) {
    ...
    try {
      this.abrirConexion();
      String sql = "select idLinea from LineaDocumento where ";
      ...
      if (this.resultSet.next()) {
        idLinea = this.resultSet.getInt("idLinea");
      }
