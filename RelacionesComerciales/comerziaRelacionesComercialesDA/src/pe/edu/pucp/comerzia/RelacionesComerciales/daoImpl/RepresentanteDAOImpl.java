...
public class RepresentanteDAOImpl extends DAOImpl implements RepresentanteDAO {
    ...
    public Integer insertar(Representante representante) {
        ...
        try {
            ...
            if (!existePersona) {
                ...
                existeRepresentante = this.existeRepresentante(this.representante, abreConexion);
            }
    ...
    protected String obtenerProyeccionParaSelect() {
        String sql = "per.idPersona, per.nombreCompleto, per.direccion, per.telefono, ";
    ...
    protected void instanciarObjetoDelResultSet() throws SQLException {
        ...
        this.representante.setNombreCompleto(this.resultSet.getString("nombreCompleto"));
