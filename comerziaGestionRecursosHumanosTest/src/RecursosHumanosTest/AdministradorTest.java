...
public class AdministradorTest {
    ...
    private static void testAdministradorBOObtenerPorId(ArrayList<Integer> listaId) {
        System.out.println("\ntestAdministradorBOObtenerPorId");
        for (Integer id : listaId) {
            Administrador administrador = administradorBO.obtenerPorId(id);
            System.out.println("idAlmacen: " + administrador.getIdAdministrador() + " " + administrador.getDni() + " " + administrador.getNombreCompleto() + " " + administrador.getTelefono() + " " + administrador.getCorreo() + " " + administrador.getDireccion() + " " + administrador.getEstado().toString() + " " + administrador.getNombreUsuario() + " " + administrador.getContrasenha() + " " + administrador.getSalario() + " " + administrador.getFechaContratacion() + " " + administrador.getIdAlmacen());
        }
    }
    ...
    private static void testAdministradorBOModificar(ArrayList<Integer> listaId) {
        ...
        Integer resultado = administradorBO.modificar(listaId.get(0),"12345678", "Juan Pérez", "987654321", "juan.perez@example.com", "Av. Principal 123", EstadoEmpleado.INACTIVO, "jperez", "contrasenha123", 2500.0, new Date(), 1);
        resultado = administradorBO.modificar(listaId.get(1),"87654321", "María Gómez", "912345678", "maria.gomez@example.com", "Calle Secundaria 456", EstadoEmpleado.ACTIVO, "mgomez", "password456", 10000.0, new Date(), 2);
    }
    ...
    private static void testAdministradorBOInsertar(ArrayList<Integer> listaId) {
        ...
        resultado = administradorBO.insertar("12345678", "Juan Pérez", "987654321", "juan.perez@example.com", "Av. Principal 123", EstadoEmpleado.ACTIVO, "jperez", "contrasenha123", 2500.0, new Date(), 1);
        System.out.println("Llave primaria insertada: " + resultado);
        listaId.add(resultado);
        
        resultado = administradorBO.insertar("87654321", "María Gómez", "912345678", "maria.gomez@example.com", "Calle Secundaria 456", EstadoEmpleado.ACTIVO, "mgomez", "password456", 3000.0, new Date(), 2);
        System.out.println("Llave primaria insertada: " + resultado);
        listaId.add(resultado);
    }
}   
