...
public class VendedorTest {
    ...
    private static void testVendedorBOInsertar(ArrayList<Integer> listaId) {
        ...
        resultado = vendedorBO.insertar("12345678", "Mariana Torres", "912345678", "mariana.torres@email.com", "Calle Las Flores 789", EstadoEmpleado.INACTIVO, "mtorres", "pass456", 2500.75, new Date(), 1000.0, 0.3457);
        System.out.println("Llave primaria insertada: " + resultado);
        listaId.add(resultado);
    }
}
