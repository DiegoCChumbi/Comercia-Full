...
public class VendedorDAOImpl extends DAOImpl implements VendedorDAO {
    ...
    protected void instanciarObjetoDelResultSet() throws SQLException {
        ...
        this.vendedor.setDireccion((this.resultSet.getString("direccion")));
        this.vendedor.setIdEmpleado(this.resultSet.getInt("idEmpleado"));
        this.vendedor.setEstado(EstadoEmpleado.valueOf(this.resultSet.getString("estado")));
        ...
        this.vendedor.setFechaContratacion(this.resultSet.getDate("fechaContratacion"));
...
//        PersonaDAO personaDAO = new PersonaDAOImpl();
    ...
    protected String generarSQLParaListarPorId() {
        ...
        sql = sql.concat("join Empleado em join Persona per on em.idEmpleado = ve.idEmpleado and em.idPersona = per.idPersona ");
