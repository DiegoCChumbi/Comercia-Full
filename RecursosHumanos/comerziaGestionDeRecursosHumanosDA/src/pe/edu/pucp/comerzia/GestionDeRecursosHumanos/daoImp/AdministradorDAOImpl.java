...
public class AdministradorDAOImpl extends DAOImpl implements AdministradorDAO {
    ...
    protected String obtenerProyeccionParaSelect() {
        ...
        sql = sql.concat("em.idEmpleado, em.estado, em.nombreUsuario, em.contrasenha, em.salario, em.fechaContratacion ,");
...
//        this.administrador.setIdPersona(this.resultSet.getInt("pe.idPersona"));
        ...
        this.administrador.setEstado(EstadoEmpleado.valueOf(this.resultSet.getString("estado")));
        this.administrador.setNombreUsuario(this.resultSet.getString("nombreUsuario"));
        ...
        this.administrador.setFechaContratacion(this.resultSet.getDate("fechaContratacion"));
...
//        PersonaDAO personaDAO = new PersonaDAOImpl();
    ...
    protected String generarSQLParaListarPorId() {
        ...
        sql = sql.concat("join Empleado em join Persona per on em.idEmpleado = ad.idEmpleado and em.idPersona = per.idPersona ");
