...
public class TrabajadorDeAlmacenDAOImpl extends DAOImpl implements TrabajadorDeAlmacenDAO {
    ...
    protected void instanciarObjetoDelResultSet() throws SQLException {
        ...
        this.trabajador.setEstado(EstadoEmpleado.valueOf(this.resultSet.getString("estado")));
        ...
        this.trabajador.setFechaContratacion(this.resultSet.getDate("fechaContratacion"));
...
//        PersonaDAO personaDAO = new PersonaDAOImpl();
    ...
    protected String generarSQLParaListarPorId() {
        ...
        sql = sql.concat("join Empleado em join Persona per on em.idEmpleado = tra.idEmpleado and em.idPersona = per.idPersona ");
