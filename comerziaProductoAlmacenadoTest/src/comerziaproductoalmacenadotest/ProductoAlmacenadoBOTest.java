...
//        testProductoAlmacenadoBOEliminar();
    ...
    private static void testProductoAlmacenadoBOEliminar() {
        ...
        for (ProductoAlmacenado productoAlmacenado : listaProductoAlmacenados) {
            productoAlmacenadoBO.eliminar(productoAlmacenado.getIdProductoAlmacenado());        
        }
    }

    private static void testProductoAlmacenadoBOObtenerPorId(ArrayList<Integer> listaId) {
        System.out.println("\ntestProductoAlmacenadoBOObtenerPorId");
        for (Integer id : listaId) {
            ProductoAlmacenado productoAlmacenado = productoAlmacenadoBO.obtenerPorId(id);
            System.out.println("idProductoAlmacenado: " + productoAlmacenado.getIdProductoAlmacenado()+ " " + productoAlmacenado.getStockActual() + " " + productoAlmacenado.getIdProducto() + " " + productoAlmacenado.getIdAlmacen());
        }
    }
    ...
    private static void testProductoAlmacenadoBOModificar(ArrayList<Integer> listaId) {
        System.out.println("\ntestProductoAlmacenadoBOModificar");
        Date fechaModificacion = new Date();
        Integer resultado = productoAlmacenadoBO.modificar(listaId.get(0),22,fechaModificacion,10,11);
        resultado = productoAlmacenadoBO.modificar(listaId.get(1),22,fechaModificacion,15,12);
    }

    private static void testProductoAlmacenadoBOInsertar(ArrayList<Integer> listaId) {
    ...
    private static void testProductoAlmacenadoBOListarPorAlmacen(Integer idAlmacen) {
