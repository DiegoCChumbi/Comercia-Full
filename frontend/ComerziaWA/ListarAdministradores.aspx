...
AutoEventWireup="true" CodeBehind="ListarAdministradores.aspx.cs"
Inherits="ComerziaWA.ListarAdministradores" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">
    ...
    >
        <button
            type="button"
            onclick="window.location.href='Administradores.aspx'"
            class="btn btn-secondary"
        >
            Regresar
        </button>
    </div>
    <h2 class="titulo-regular">Lista de Administradores</h2>
